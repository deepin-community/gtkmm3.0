...
ImageMenuItem::ImageMenuItem(ImageMenuItem&& src) noexcept
: Gtk::MenuItem(std::move(src))
{}

ImageMenuItem& ImageMenuItem::operator=(ImageMenuItem&& src) noexcept
{
  Gtk::MenuItem::operator=(std::move(src));
  return *this;
}

ImageMenuItem::~ImageMenuItem() noexcept
{
  destroy_();
}
