...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,PrintOperationResult >;
...
Glib::SignalProxy< void,PrintOperationResult > PrintOperation::signal_done()
{
  return Glib::SignalProxy< void,PrintOperationResult >(this, &PrintOperation_signal_done_info);
}
