...
:
  ...
  Gtk::Window(Glib::ConstructParams(dialog_class_.init(), "title",title.c_str(), nullptr))
{
  set_modal(modal);
...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gtk::Window(Glib::ConstructParams(dialog_class_.init(), "title",title.c_str(),"use-header-bar",(flags & DIALOG_USE_HEADER_BAR) != 0, nullptr))
{
