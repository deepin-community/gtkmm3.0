...
{
  using namespace Gtk;
  using SlotType = sigc::slot< bool,const Glib::RefPtr<Glib::Object>&,guint,Gdk::ModifierType >;
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,const Glib::RefPtr<Glib::Object>&,guint,Gdk::ModifierType >;
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,guint,Gdk::ModifierType,GClosure* >;
...
Glib::SignalProxy< bool,const Glib::RefPtr<Glib::Object>&,guint,Gdk::ModifierType > AccelGroup::signal_accel_activate()
{
  return Glib::SignalProxy< bool,const Glib::RefPtr<Glib::Object>&,guint,Gdk::ModifierType >(this, &AccelGroup_signal_accel_activate_info);
}
#endif // GTKMM_DISABLE_DEPRECATED


Glib::SignalProxy< void,guint,Gdk::ModifierType,GClosure* > AccelGroup::signal_accel_changed()
{
