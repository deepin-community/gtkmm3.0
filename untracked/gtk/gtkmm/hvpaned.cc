...
HPaned::HPaned(HPaned&& src) noexcept
: Gtk::Paned(std::move(src))
{}

HPaned& HPaned::operator=(HPaned&& src) noexcept
{
  Gtk::Paned::operator=(std::move(src));
  return *this;
}

HPaned::~HPaned() noexcept
{
  destroy_();
}
...
VPaned::VPaned(VPaned&& src) noexcept
: Gtk::Paned(std::move(src))
{}

VPaned& VPaned::operator=(VPaned&& src) noexcept
{
  Gtk::Paned::operator=(std::move(src));
  return *this;
}

VPaned::~VPaned() noexcept
{
  destroy_();
}
