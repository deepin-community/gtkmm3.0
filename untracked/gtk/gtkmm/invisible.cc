...
Invisible::Invisible(Invisible&& src) noexcept
: Gtk::Widget(std::move(src))
{}

Invisible& Invisible::operator=(Invisible&& src) noexcept
{
  Gtk::Widget::operator=(std::move(src));
  return *this;
}

Invisible::~Invisible() noexcept
{
  destroy_();
}
...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gtk::Widget(Glib::ConstructParams(invisible_class_.init(), "screen", Glib::unwrap(screen), nullptr))
{
...
Glib::PropertyProxy< Glib::RefPtr<Gdk::Screen> > Invisible::property_screen() 
{
  return Glib::PropertyProxy< Glib::RefPtr<Gdk::Screen> >(this, "screen");
}

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<Gdk::Screen> > Invisible::property_screen() const
{
