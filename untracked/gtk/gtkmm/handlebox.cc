...
Glib::SignalProxy< void,Widget* > HandleBox::signal_child_attached()
{
  return Glib::SignalProxy< void,Widget* >(this, &HandleBox_signal_child_attached_info);
}


Glib::SignalProxy< void,Widget* > HandleBox::signal_child_detached()
{
  return Glib::SignalProxy< void,Widget* >(this, &HandleBox_signal_child_detached_info);
}
