...
:
  ...
  Gtk::Container(Glib::ConstructParams(paned_class_.init(), "orientation", ((GtkOrientation)(orientation)), nullptr))
{
...
{
  Glib::RefPtr<Gdk::Window> retvalue = Glib::wrap(gtk_paned_get_handle_window(gobj()));
  if(retvalue)
...
Gtk::ChildPropertyProxy< bool > Paned::child_property_resize(Gtk::Widget& child) 
{
  return Gtk::ChildPropertyProxy< bool >(this, child, "resize");
}

Gtk::ChildPropertyProxy_ReadOnly< bool > Paned::child_property_resize(const Gtk::Widget& child) const
{
  return Gtk::ChildPropertyProxy_ReadOnly< bool >(this, child, "resize");
}

Gtk::ChildPropertyProxy< bool > Paned::child_property_shrink(Gtk::Widget& child) 
{
  return Gtk::ChildPropertyProxy< bool >(this, child, "shrink");
}

Gtk::ChildPropertyProxy_ReadOnly< bool > Paned::child_property_shrink(const Gtk::Widget& child) const
{
  return Gtk::ChildPropertyProxy_ReadOnly< bool >(this, child, "shrink");
}
