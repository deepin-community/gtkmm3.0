...
static void TextView_signal_populate_popup_callback(GtkTextView* self, GtkWidget* p0,void* data)
{
  using namespace Gtk;
...
void TextView_Class::populate_popup_callback(GtkTextView* self, GtkWidget* p0)
{
...
void TextView::get_cursor_locations(const TextBuffer::iterator& iter, Gdk::Rectangle& strong, Gdk::Rectangle& weak) const
{
...
{
  Glib::RefPtr<Gdk::Window> retvalue = Glib::wrap(gtk_text_view_get_window(gobj(), ((GtkTextWindowType)(win))));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}
...
bool TextView::im_context_filter_keypress(GdkEventKey* gdk_event)
{
  return gtk_text_view_im_context_filter_keypress(gobj(), gdk_event);
}
...
{
  gtk_text_view_set_input_purpose(gobj(), ((GtkInputPurpose)(purpose)));
}

InputPurpose TextView::get_input_purpose() const
{
  return ((InputPurpose)(gtk_text_view_get_input_purpose(const_cast<GtkTextView*>(gobj()))));
}

void TextView::set_input_hints(InputHints hints)
{
  gtk_text_view_set_input_hints(gobj(), ((GtkInputHints)(hints)));
}

InputHints TextView::get_input_hints() const
{
  return ((InputHints)(gtk_text_view_get_input_hints(const_cast<GtkTextView*>(gobj()))));
}
...
Glib::SignalProxy< void,Menu* > TextView::signal_populate_popup()
{
  return Glib::SignalProxy< void,Menu* >(this, &TextView_signal_populate_popup_info);
}
...
Glib::PropertyProxy< bool > TextView::property_populate_all() 
{
  return Glib::PropertyProxy< bool >(this, "populate-all");
}

Glib::PropertyProxy_ReadOnly< bool > TextView::property_populate_all() const
{
