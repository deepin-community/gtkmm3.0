...
// static
GType Glib::Value<Gtk::CssSectionType>::value_type()
{
  return gtk_css_section_type_get_type();
}
...
CssSectionType CssSection::get_section_type() const
{
  return ((CssSectionType)(gtk_css_section_get_section_type(const_cast<GtkCssSection*>(gobj()))));
}

Glib::RefPtr<CssSection> CssSection::get_parent()
{
  Glib::RefPtr<CssSection> retvalue = Glib::wrap(gtk_css_section_get_parent(gobj()));
  if(retvalue)
...
{
  Glib::RefPtr<Gio::File> retvalue = Glib::wrap(gtk_css_section_get_file(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}
...
unsigned int CssSection::get_start_line() const
{
  return gtk_css_section_get_start_line(const_cast<GtkCssSection*>(gobj()));
}

unsigned int CssSection::get_start_position() const
{
  return gtk_css_section_get_start_position(const_cast<GtkCssSection*>(gobj()));
}

unsigned int CssSection::get_end_line() const
{
  return gtk_css_section_get_end_line(const_cast<GtkCssSection*>(gobj()));
}

unsigned int CssSection::get_end_position() const
{
  return gtk_css_section_get_end_position(const_cast<GtkCssSection*>(gobj()));
}
