...
ToolPalette::ToolPalette(ToolPalette&& src) noexcept
: Gtk::Container(std::move(src))
  , Orientable(std::move(src))
  , Scrollable(std::move(src))
{}

ToolPalette& ToolPalette::operator=(ToolPalette&& src) noexcept
{
...
ToolPalette::~ToolPalette() noexcept
{
  destroy_();
}
...
Gtk::ChildPropertyProxy< bool > ToolPalette::child_property_exclusive(Gtk::Widget& child) 
{
  return Gtk::ChildPropertyProxy< bool >(this, child, "exclusive");
}

Gtk::ChildPropertyProxy_ReadOnly< bool > ToolPalette::child_property_exclusive(const Gtk::Widget& child) const
{
  return Gtk::ChildPropertyProxy_ReadOnly< bool >(this, child, "exclusive");
}

Gtk::ChildPropertyProxy< bool > ToolPalette::child_property_expand(Gtk::Widget& child) 
{
  return Gtk::ChildPropertyProxy< bool >(this, child, "expand");
}

Gtk::ChildPropertyProxy_ReadOnly< bool > ToolPalette::child_property_expand(const Gtk::Widget& child) const
{
