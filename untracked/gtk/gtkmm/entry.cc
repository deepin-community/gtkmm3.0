...
static void Entry_signal_populate_popup_callback(GtkEntry* self, GtkWidget* p0,void* data)
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,Menu* >;
  ...
  if(obj)
  {
    try
    {
      if(const auto slot = Glib::SignalProxyNormal::data_to_slot(data))
        (*static_cast<SlotType*>(slot))(Glib::wrap((GtkMenu*)(p0))
);
    }
    catch(...)
    {
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,EntryIconPosition,const GdkEventButton* >;
...
void Entry_Class::populate_popup_callback(GtkEntry* self, GtkWidget* p0)
{
  ...
  if(obj_base && obj_base->is_derived_())
  {
    ...
    if(obj) // This can be NULL during destruction.
    {
      try // Trap C++ exceptions which would normally be lost because this is a C callback.
      {
        ...
        obj->on_populate_popup(Glib::wrap((GtkMenu*)(p0))
);
        return;
      }
      catch(...)
...
void Entry::set_max_width_chars(int n_chars)
{
  gtk_entry_set_max_width_chars(gobj(), n_chars);
}

int Entry::get_max_width_chars() const
{
  return gtk_entry_get_max_width_chars(const_cast<GtkEntry*>(gobj()));
}
...
bool Entry::im_context_filter_keypress(GdkEventKey* gdk_event)
{
  return gtk_entry_im_context_filter_keypress(gobj(), gdk_event);
}
...
{
  gtk_entry_set_input_purpose(gobj(), ((GtkInputPurpose)(purpose)));
}

InputPurpose Entry::get_input_purpose() const
{
  return ((InputPurpose)(gtk_entry_get_input_purpose(const_cast<GtkEntry*>(gobj()))));
}

void Entry::set_input_hints(InputHints hints)
{
  gtk_entry_set_input_hints(gobj(), ((GtkInputHints)(hints)));
}

InputHints Entry::get_input_hints() const
{
  return ((InputHints)(gtk_entry_get_input_hints(const_cast<GtkEntry*>(gobj()))));
}
...
Glib::SignalProxy< void,Menu* > Entry::signal_populate_popup()
{
  return Glib::SignalProxy< void,Menu* >(this, &Entry_signal_populate_popup_info);
}


Glib::SignalProxy< void,const Glib::ustring& > Entry::signal_insert_at_cursor()
{
  return Glib::SignalProxy< void,const Glib::ustring& >(this, &Entry_signal_insert_at_cursor_info);
}
...
Glib::SignalProxy< void,EntryIconPosition,const GdkEventButton* > Entry::signal_icon_release()
{
  return Glib::SignalProxy< void,EntryIconPosition,const GdkEventButton* >(this, &Entry_signal_icon_release_info);
}


Glib::SignalProxy< void,EntryIconPosition,const GdkEventButton* > Entry::signal_icon_press()
{
  return Glib::SignalProxy< void,EntryIconPosition,const GdkEventButton* >(this, &Entry_signal_icon_press_info);
}
...
Glib::PropertyProxy< int > Entry::property_max_width_chars() 
{
  return Glib::PropertyProxy< int >(this, "max-width-chars");
}

Glib::PropertyProxy_ReadOnly< int > Entry::property_max_width_chars() const
{
...
Glib::PropertyProxy< bool > Entry::property_populate_all() 
{
  return Glib::PropertyProxy< bool >(this, "populate-all");
}

Glib::PropertyProxy_ReadOnly< bool > Entry::property_populate_all() const
{
...
void Gtk::Entry::on_populate_popup(Menu* menu)
{
  ...
  if(base && base->populate_popup)
    (*base->populate_popup)(gobj(),GTK_WIDGET((menu)->gobj()));
}
