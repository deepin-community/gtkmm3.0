...
{
  return Glib::RefPtr<Gtk::EventController>( dynamic_cast<Gtk::EventController*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
bool EventController::handle_event(const GdkEvent* event)
{
  return gtk_event_controller_handle_event(gobj(), event);
}
...
{
  return ((PropagationPhase)(gtk_event_controller_get_propagation_phase(const_cast<GtkEventController*>(gobj()))));
}

void EventController::set_propagation_phase(PropagationPhase phase)
{
  gtk_event_controller_set_propagation_phase(gobj(), ((GtkPropagationPhase)(phase)));
}
