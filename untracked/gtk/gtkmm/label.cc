...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gtk::Misc(Glib::ConstructParams(label_class_.init(), "label",label.c_str(),"use_underline",gboolean(mnemonic), nullptr))
{}
...
Glib::SignalProxy< void,Menu* > Label::signal_populate_popup()
{
  return Glib::SignalProxy< void,Menu* >(this, &Label_signal_populate_popup_info);
}
