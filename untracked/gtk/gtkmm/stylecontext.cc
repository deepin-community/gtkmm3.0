...
void StyleContext::set_frame_clock(const Glib::RefPtr<Gdk::FrameClock>& frame_clock)
{
  gtk_style_context_set_frame_clock(gobj(), Glib::unwrap(frame_clock));
}

Glib::RefPtr<Gdk::FrameClock> StyleContext::get_frame_clock()
{
  Glib::RefPtr<Gdk::FrameClock> retvalue = Glib::wrap(gtk_style_context_get_frame_clock(gobj()));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}

Glib::RefPtr<const Gdk::FrameClock> StyleContext::get_frame_clock() const
{
  return const_cast<StyleContext*>(this)->get_frame_clock();
}
...
Glib::PropertyProxy< Glib::RefPtr<Gdk::FrameClock> > StyleContext::property_paint_clock() 
{
  return Glib::PropertyProxy< Glib::RefPtr<Gdk::FrameClock> >(this, "paint-clock");
}

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<Gdk::FrameClock> > StyleContext::property_paint_clock() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::RefPtr<Gdk::FrameClock> >(this, "paint-clock");
}
