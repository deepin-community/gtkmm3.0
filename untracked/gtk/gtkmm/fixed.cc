...
Gtk::ChildPropertyProxy< int > Fixed::child_property_x(Gtk::Widget& child) 
{
  return Gtk::ChildPropertyProxy< int >(this, child, "x");
}

Gtk::ChildPropertyProxy_ReadOnly< int > Fixed::child_property_x(const Gtk::Widget& child) const
{
  return Gtk::ChildPropertyProxy_ReadOnly< int >(this, child, "x");
}

Gtk::ChildPropertyProxy< int > Fixed::child_property_y(Gtk::Widget& child) 
{
  return Gtk::ChildPropertyProxy< int >(this, child, "y");
}

Gtk::ChildPropertyProxy_ReadOnly< int > Fixed::child_property_y(const Gtk::Widget& child) const
{
