...
RecentChooserWidget::RecentChooserWidget(RecentChooserWidget&& src) noexcept
: Gtk::VBox(std::move(src))
  , RecentChooser(std::move(src))
{}

RecentChooserWidget& RecentChooserWidget::operator=(RecentChooserWidget&& src) noexcept
{
...
RecentChooserWidget::~RecentChooserWidget() noexcept
{
  destroy_();
}
...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gtk::VBox(Glib::ConstructParams(recentchooserwidget_class_.init(), "recent_manager", Glib::unwrap(recent_manager), nullptr))
{
