...
{
  return Glib::RefPtr<Gtk::NativeDialog>( dynamic_cast<Gtk::NativeDialog*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
int NativeDialog::run()
{
  return gtk_native_dialog_run(gobj());
}
