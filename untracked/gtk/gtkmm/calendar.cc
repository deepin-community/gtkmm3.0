...
Glib::SignalProxy< void > Calendar::signal_month_changed()
{
  return Glib::SignalProxy< void >(this, &Calendar_signal_month_changed_info);
}
...
Glib::SignalProxy< void > Calendar::signal_day_selected_double_click()
{
  return Glib::SignalProxy< void >(this, &Calendar_signal_day_selected_double_click_info);
}
