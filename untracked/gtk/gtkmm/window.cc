...
:
  ...
  Gtk::Bin(Glib::ConstructParams(window_class_.init(), "type", ((GtkWindowType)(type)), nullptr))
{
...
void Window::show_uri(const Glib::ustring& uri, guint32 timestamp)
{
  GError* gerror = nullptr;
  gtk_show_uri_on_window(gobj(), uri.c_str(), timestamp, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
}


Glib::SignalProxy< void,Widget* > Window::signal_set_focus()
{
  return Glib::SignalProxy< void,Widget* >(this, &Window_signal_set_focus_info);
}
