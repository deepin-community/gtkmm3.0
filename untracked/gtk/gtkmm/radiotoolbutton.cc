...
RadioToolButton::RadioToolButton(RadioToolButton&& src) noexcept
: Gtk::ToggleToolButton(std::move(src))
{}

RadioToolButton& RadioToolButton::operator=(RadioToolButton&& src) noexcept
{
  Gtk::ToggleToolButton::operator=(std::move(src));
  return *this;
}

RadioToolButton::~RadioToolButton() noexcept
{
  destroy_();
}
...
Glib::PropertyProxy_WriteOnly< RadioToolButton* > RadioToolButton::property_group() 
{
  return Glib::PropertyProxy_WriteOnly< RadioToolButton* >(this, "group");
}
