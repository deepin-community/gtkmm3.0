...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,guint,const gchar*,guint >;
...
Glib::SignalProxy< void,guint,const gchar*,guint > EntryBuffer::signal_inserted_text()
{
  return Glib::SignalProxy< void,guint,const gchar*,guint >(this, &EntryBuffer_signal_inserted_text_info);
}
