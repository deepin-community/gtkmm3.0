...
void Tooltip::set_icon(const Glib::RefPtr<Gio::Icon>& gicon, IconSize size)
{
  gtk_tooltip_set_icon_from_gicon(gobj(), const_cast<GIcon*>(Glib::unwrap<Gio::Icon>(gicon)), static_cast<GtkIconSize>(int(size)));
}
