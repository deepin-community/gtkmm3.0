...
:
  ...
  Gtk::ToggleAction(Glib::ConstructParams(radioaction_class_.init(), "name",name.c_str(),"stock_id",stock_id.get_c_str(),"label",(label.empty() ? nullptr : label.c_str()),"tooltip",(tooltip.empty() ? nullptr : tooltip.c_str()), nullptr))
{
  set_group(group);
}
...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gtk::ToggleAction(Glib::ConstructParams(radioaction_class_.init(), "name",name.c_str(),"icon_name",icon_name.c_str(),"label",(label.empty() ? nullptr : label.c_str()),"tooltip",(tooltip.empty() ? nullptr : tooltip.c_str()), nullptr))
{
  set_group(group);
}
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,const Glib::RefPtr<RadioAction>& >;

  auto obj = dynamic_cast<RadioAction*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
RadioAction::RadioAction(RadioAction&& src) noexcept
: Gtk::ToggleAction(std::move(src))
{}

RadioAction& RadioAction::operator=(RadioAction&& src) noexcept
{
  Gtk::ToggleAction::operator=(std::move(src));
  return *this;
}


RadioAction::~RadioAction() noexcept
{}
...
#ifndef GTKMM_DISABLE_DEPRECATED
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
void RadioAction::join_group(const Glib::RefPtr<RadioAction>& group_source)
{
  gtk_radio_action_join_group(gobj(), Glib::unwrap(group_source));
}
G_GNUC_END_IGNORE_DEPRECATIONS
#endif // GTKMM_DISABLE_DEPRECATED
...
Glib::SignalProxy< void,const Glib::RefPtr<RadioAction>& > RadioAction::signal_changed()
{
  return Glib::SignalProxy< void,const Glib::RefPtr<RadioAction>& >(this, &RadioAction_signal_changed_info);
}
#endif // GTKMM_DISABLE_DEPRECATED
