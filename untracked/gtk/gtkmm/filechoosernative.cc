...
{
  return Glib::RefPtr<Gtk::FileChooserNative>( dynamic_cast<Gtk::FileChooserNative*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
const Glib::Class& FileChooserNative_Class::init()
{
  if(!gtype_) // create the GType if necessary
  {
    ...
    register_derived_type(gtk_file_chooser_native_get_type());
...
Glib::RefPtr<FileChooserNative> FileChooserNative::create(const Glib::ustring& title, Window& parent, FileChooserAction action, const Glib::ustring& accept_label, const Glib::ustring& cancel_label)
{
  return Glib::RefPtr<FileChooserNative>( new FileChooserNative(title, parent, action, accept_label, cancel_label) );
}

Glib::RefPtr<FileChooserNative> FileChooserNative::create(const Glib::ustring& title, FileChooserAction action, const Glib::ustring& accept_label, const Glib::ustring& cancel_label)
{
  return Glib::RefPtr<FileChooserNative>( new FileChooserNative(title, action, accept_label, cancel_label) );
}
