...
ButtonBox::ButtonBox(ButtonBox&& src) noexcept
: Gtk::Box(std::move(src))
{}

ButtonBox& ButtonBox::operator=(ButtonBox&& src) noexcept
{
  Gtk::Box::operator=(std::move(src));
  return *this;
}

ButtonBox::~ButtonBox() noexcept
{
  destroy_();
}
...
:
  ...
  Gtk::Box(Glib::ConstructParams(buttonbox_class_.init(), "orientation", ((GtkOrientation)(orientation)), nullptr))
{
