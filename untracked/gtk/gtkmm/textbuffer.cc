...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,const TextBuffer::iterator&,const Glib::ustring&,int >;
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,const TextBuffer::iterator&,const Glib::RefPtr<Gdk::Pixbuf>& >;
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,const TextBuffer::iterator&,const Glib::RefPtr<ChildAnchor>& >;
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,const TextBuffer::iterator&,const TextBuffer::iterator& >;
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,const Glib::RefPtr<Gtk::Clipboard>& >;
...
Glib::ustring TextBuffer::get_text(const iterator& range_start, const iterator& range_end, bool include_hidden_chars) const
{
...
Glib::ustring TextBuffer::get_slice(const iterator& range_start, const iterator& range_end, bool include_hidden_chars) const
{
...
bool TextBuffer::get_selection_bounds(iterator& range_start, iterator& range_end) const
{
...
{
  return Gdk::AtomUstring::to_cpp_type(gtk_text_buffer_register_serialize_tagset(gobj(), tagset_name.c_str()));
}

Glib::ustring TextBuffer::register_deserialize_tagset(const Glib::ustring& tagset_name)
{
  return Gdk::AtomUstring::to_cpp_type(gtk_text_buffer_register_deserialize_tagset(gobj(), tagset_name.c_str()));
}

void TextBuffer::unregister_serialize_format(const Glib::ustring& format)
{
  gtk_text_buffer_unregister_serialize_format(gobj(), Gdk::AtomUstring::to_c_type(format));
}

void TextBuffer::unregister_deserialize_format(const Glib::ustring& format)
{
  gtk_text_buffer_unregister_deserialize_format(gobj(), Gdk::AtomUstring::to_c_type(format));
}

void TextBuffer::set_can_create_tags(const Glib::ustring& format, bool can_create_tags)
{
  gtk_text_buffer_deserialize_set_can_create_tags(gobj(), Gdk::AtomUstring::to_c_type(format), static_cast<int>(can_create_tags));
}

bool TextBuffer::get_can_create_tags(const Glib::ustring& format) const
{
  return gtk_text_buffer_deserialize_get_can_create_tags(const_cast<GtkTextBuffer*>(gobj()), Gdk::AtomUstring::to_c_type(format));
}

guint8* TextBuffer::serialize(const Glib::RefPtr<TextBuffer>& content_buffer, const Glib::ustring& format, const iterator& range_start, const iterator& range_end, gsize& length)
{
  return gtk_text_buffer_serialize(gobj(), Glib::unwrap(content_buffer), Gdk::AtomUstring::to_c_type(format), (range_start).gobj(), (range_end).gobj(), &(length));
}

bool TextBuffer::deserialize(const Glib::RefPtr<TextBuffer>& content_buffer, const Glib::ustring& format, iterator& iter, const guint8* data, gsize length)
{
  GError* gerror = nullptr;
  bool retvalue = gtk_text_buffer_deserialize(gobj(), Glib::unwrap(content_buffer), Gdk::AtomUstring::to_c_type(format), (iter).gobj(), data, length, &(gerror));
  if(gerror)
...
Glib::SignalProxy< void,const TextBuffer::iterator&,const Glib::ustring&,int > TextBuffer::signal_insert()
{
  return Glib::SignalProxy< void,const TextBuffer::iterator&,const Glib::ustring&,int >(this, &TextBuffer_signal_insert_info);
}


Glib::SignalProxy< void,const TextBuffer::iterator&,const Glib::RefPtr<Gdk::Pixbuf>& > TextBuffer::signal_insert_pixbuf()
{
  return Glib::SignalProxy< void,const TextBuffer::iterator&,const Glib::RefPtr<Gdk::Pixbuf>& >(this, &TextBuffer_signal_insert_pixbuf_info);
}


Glib::SignalProxy< void,const TextBuffer::iterator&,const Glib::RefPtr<ChildAnchor>& > TextBuffer::signal_insert_child_anchor()
{
  return Glib::SignalProxy< void,const TextBuffer::iterator&,const Glib::RefPtr<ChildAnchor>& >(this, &TextBuffer_signal_insert_child_anchor_info);
}


Glib::SignalProxy< void,const TextBuffer::iterator&,const TextBuffer::iterator& > TextBuffer::signal_erase()
{
  return Glib::SignalProxy< void,const TextBuffer::iterator&,const TextBuffer::iterator& >(this, &TextBuffer_signal_erase_info);
}
...
Glib::SignalProxy< void,const Glib::RefPtr<Gtk::Clipboard>& > TextBuffer::signal_paste_done()
{
  return Glib::SignalProxy< void,const Glib::RefPtr<Gtk::Clipboard>& >(this, &TextBuffer_signal_paste_done_info);
}
...
Glib::PropertyProxy_ReadOnly< Glib::RefPtr<TargetList> > TextBuffer::property_copy_target_list() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::RefPtr<TargetList> >(this, "copy-target-list");
}

Glib::PropertyProxy_ReadOnly< Glib::RefPtr<TargetList> > TextBuffer::property_paste_target_list() const
{
  return Glib::PropertyProxy_ReadOnly< Glib::RefPtr<TargetList> >(this, "paste-target-list");
}
...
void Gtk::TextBuffer::on_erase(const TextBuffer::iterator& range_start, const TextBuffer::iterator& range_end)
{
  const auto base = static_cast<BaseClassType*>(
      g_type_class_peek_parent(G_OBJECT_GET_CLASS(gobject_)) // Get the parent class of the object class (The original underlying C class).
  );
  ...
  if(base && base->delete_range)
    (*base->delete_range)(gobj(),const_cast<GtkTextIter*>((range_start).gobj()),const_cast<GtkTextIter*>((range_end).gobj()));
}
