...
Plug::Plug(Plug&& src) noexcept
: Gtk::Window(std::move(src))
{}

Plug& Plug::operator=(Plug&& src) noexcept
{
...
Glib::SignalProxy< void > Plug::signal_embedded()
{
  return Glib::SignalProxy< void >(this, &Plug_signal_embedded_info);
}
