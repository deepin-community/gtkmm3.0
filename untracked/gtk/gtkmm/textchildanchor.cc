...
{
  return Glib::ListHandler<Widget*>::list_to_vector(gtk_text_child_anchor_get_widgets(gobj()), Glib::OWNERSHIP_SHALLOW);
}

std::vector<const Widget*> TextChildAnchor::get_widgets() const
{
  return Glib::ListHandler<const Widget*>::list_to_vector(gtk_text_child_anchor_get_widgets(const_cast<GtkTextChildAnchor*>(gobj())), Glib::OWNERSHIP_SHALLOW);
}
