...
Widget* WindowGroup::get_current_grab()
{
  return Glib::wrap(gtk_window_group_get_current_grab(gobj()));
}

const Widget* WindowGroup::get_current_grab() const
{
  return const_cast<WindowGroup*>(this)->get_current_grab();
}

Widget* WindowGroup::get_current_grab(const Glib::RefPtr<const Gdk::Device>& device)
{
  return Glib::wrap(gtk_window_group_get_current_device_grab(gobj(), const_cast<GdkDevice*>(Glib::unwrap<Gdk::Device>(device))));
}

const Widget* WindowGroup::get_current_grab(const Glib::RefPtr<const Gdk::Device>& device) const
{
  return const_cast<WindowGroup*>(this)->get_current_grab(device);
}
