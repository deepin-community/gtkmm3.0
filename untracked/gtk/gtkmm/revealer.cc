...
:
  ...
  Gtk::Bin(Glib::ConstructParams(revealer_class_.init()))
{
...
{
  return ((RevealerTransitionType)(gtk_revealer_get_transition_type(const_cast<GtkRevealer*>(gobj()))));
}

void Revealer::set_transition_type(RevealerTransitionType transition)
{
  gtk_revealer_set_transition_type(gobj(), ((GtkRevealerTransitionType)(transition)));
}
