...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gtk::CheckButton(Glib::ConstructParams(radiobutton_class_.init(), "label",label.c_str(),"use_underline",gboolean(mnemonic), nullptr))
{}
...
void RadioButton::join_group(RadioButton& group_source)
{
  gtk_radio_button_join_group(gobj(), (group_source).gobj());
}


Glib::SignalProxy< void > RadioButton::signal_group_changed()
{
  return Glib::SignalProxy< void >(this, &RadioButton_signal_group_changed_info);
}


Glib::PropertyProxy_WriteOnly< RadioButton* > RadioButton::property_group() 
{
  return Glib::PropertyProxy_WriteOnly< RadioButton* >(this, "group");
}
