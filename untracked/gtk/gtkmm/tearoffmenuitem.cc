...
TearoffMenuItem::TearoffMenuItem(TearoffMenuItem&& src) noexcept
: Gtk::MenuItem(std::move(src))
{}

TearoffMenuItem& TearoffMenuItem::operator=(TearoffMenuItem&& src) noexcept
{
  Gtk::MenuItem::operator=(std::move(src));
  return *this;
}

TearoffMenuItem::~TearoffMenuItem() noexcept
{
  destroy_();
}
