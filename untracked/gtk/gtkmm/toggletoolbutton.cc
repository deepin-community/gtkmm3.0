...
:
  ...
  Gtk::ToolButton(Glib::ConstructParams(toggletoolbutton_class_.init(), "stock_id", (stock_id).get_c_str(), nullptr))
{
}
...
:
  Glib::ObjectBase(nullptr), //Mark this class as gtkmmproc-generated, rather than a custom class, to allow vfunc optimisations.
  Gtk::ToolButton(Glib::ConstructParams(toggletoolbutton_class_.init(), "icon_widget", (icon_widget).gobj(), "label", label.c_str(), nullptr))
{
}
...
Glib::SignalProxy< void > ToggleToolButton::signal_toggled()
{
  return Glib::SignalProxy< void >(this, &ToggleToolButton_signal_toggled_info);
}
