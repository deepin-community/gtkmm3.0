...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gtk::Container(Glib::ConstructParams(iconview_class_.init(), "model", Glib::unwrap(model), nullptr))
{
...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gtk::Container(Glib::ConstructParams(iconview_class_.init(), "cell_area", Glib::unwrap(cell_area), nullptr))
{
...
Cairo::RefPtr<Cairo::Surface> IconView::create_drag_icon(const TreeModel::Path& path)
{
  return Cairo::RefPtr<Cairo::Surface>(new Cairo::Surface(gtk_icon_view_create_drag_icon(gobj(), const_cast<GtkTreePath*>((path).gobj())), false /* take reference */));
}
...
bool IconView::get_cell_rect(const TreeModel::Path& path, const CellRenderer& cell, Gdk::Rectangle& rect) const
{
  ...
  bool retvalue = gtk_icon_view_get_cell_rect(const_cast<GtkIconView*>(gobj()), const_cast<GtkTreePath*>((path).gobj()), const_cast<GtkCellRenderer*>((cell).gobj()), &g_rect);
...
{
  GdkRectangle g_rect = GdkRectangle();
  bool retvalue = gtk_icon_view_get_cell_rect(const_cast<GtkIconView*>(gobj()), const_cast<GtkTreePath*>((path).gobj()), nullptr, &g_rect);
rect = Glib::wrap(&(g_rect));
  return retvalue;
}
