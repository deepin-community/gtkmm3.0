...
{
  return Glib::RefPtr<Gtk::GestureZoom>( dynamic_cast<Gtk::GestureZoom*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
GestureZoom::GestureZoom(Widget& widget)
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Gesture(Glib::ConstructParams(gesturezoom_class_.init(), "widget", (widget).gobj(), nullptr))
{
  

}

Glib::RefPtr<GestureZoom> GestureZoom::create(Widget& widget)
{
  return Glib::RefPtr<GestureZoom>( new GestureZoom(widget) );
}
