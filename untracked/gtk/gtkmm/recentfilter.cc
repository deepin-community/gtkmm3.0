...
{
  const auto the_slot = static_cast<Gtk::RecentFilter::SlotCustom*>(data);
  ...
  try
  {
    ...
    {
      cppInfo.applications.emplace_back( Glib::convert_const_gchar_ptr_to_ustring(filter_info->applications[i]) );
    }
...
RecentFilter::RecentFilter(RecentFilter&& src) noexcept
: Glib::Object(std::move(src))
{}

RecentFilter& RecentFilter::operator=(RecentFilter&& src) noexcept
{
...
RecentFilter::~RecentFilter() noexcept
{}
