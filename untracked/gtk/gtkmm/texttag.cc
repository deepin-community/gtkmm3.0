...
{
  using namespace Gtk;
  using SlotType = sigc::slot< bool,const Glib::RefPtr<Glib::Object>&,GdkEvent*,const TextIter& >;
...
{
  using namespace Gtk;
  using SlotType = sigc::slot< void,const Glib::RefPtr<Glib::Object>&,GdkEvent*,const TextIter& >;
...
Glib::SignalProxy< bool,const Glib::RefPtr<Glib::Object>&,GdkEvent*,const TextIter& > TextTag::signal_event()
{
  return Glib::SignalProxy< bool,const Glib::RefPtr<Glib::Object>&,GdkEvent*,const TextIter& >(this, &TextTag_signal_event_info);
}
