...
bool PrintSettings::load_from_key_file(const Glib::KeyFile& key_file)
{
  ...
  bool retvalue = gtk_print_settings_load_key_file(gobj(), const_cast<GKeyFile*>((key_file).gobj()), nullptr, &(gerror));
  if(gerror)
...
{
  gtk_print_settings_set_print_pages(gobj(), ((GtkPrintPages)(pages)));
}
