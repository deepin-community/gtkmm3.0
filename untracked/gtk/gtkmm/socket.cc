...
static gboolean Socket_signal_plug_removed_callback(GtkSocket* self, void* data)
{
  ...
  auto obj = dynamic_cast<Socket*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
Glib::SignalProxy< void > Socket::signal_plug_added()
{
  return Glib::SignalProxy< void >(this, &Socket_signal_plug_added_info);
}


Glib::SignalProxy< bool > Socket::signal_plug_removed()
{
  return Glib::SignalProxy< bool >(this, &Socket_signal_plug_removed_info);
}
