...
:
  ...
  Gtk::ToolButton(Glib::ConstructParams(menutoolbutton_class_.init(), "stock_id", (stock_id).get_c_str(), nullptr))
{
}
...
:
  Glib::ObjectBase(nullptr), //Mark this class as gtkmmproc-generated, rather than a custom class, to allow vfunc optimisations.
  Gtk::ToolButton(Glib::ConstructParams(menutoolbutton_class_.init(), "icon_widget", (icon_widget).gobj(), "label", label.c_str(), nullptr))
{
}
...
MenuToolButton::MenuToolButton(MenuToolButton&& src) noexcept
: Gtk::ToolButton(std::move(src))
{}

MenuToolButton& MenuToolButton::operator=(MenuToolButton&& src) noexcept
{
  Gtk::ToolButton::operator=(std::move(src));
  return *this;
}

MenuToolButton::~MenuToolButton() noexcept
{
  destroy_();
}
...
Glib::SignalProxy< void > MenuToolButton::signal_show_menu()
{
  return Glib::SignalProxy< void >(this, &MenuToolButton_signal_show_menu_info);
}
