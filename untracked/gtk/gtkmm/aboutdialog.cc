...
:
  ...
  Gtk::Dialog(Glib::ConstructParams(aboutdialog_class_.init(), "use-header-bar",static_cast<int>(use_header_bar), nullptr))
{
}
...
{
  Glib::RefPtr<Gdk::Pixbuf> retvalue = Glib::wrap(gtk_about_dialog_get_logo(gobj()));
  if(retvalue)
