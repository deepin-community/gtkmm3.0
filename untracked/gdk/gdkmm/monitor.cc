...
{
  return Glib::RefPtr<Gdk::Monitor>( dynamic_cast<Gdk::Monitor*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
{
  Glib::RefPtr<Display> retvalue = Glib::wrap(gdk_monitor_get_display(gobj()));
  if(retvalue)
...
void Monitor::get_workarea(Rectangle& workarea) const
{
  gdk_monitor_get_workarea(const_cast<GdkMonitor*>(gobj()), (workarea).gobj());
}
...
{
  return ((SubpixelLayout)(gdk_monitor_get_subpixel_layout(const_cast<GdkMonitor*>(gobj()))));
}

bool Monitor::is_primary() const
{
  return gdk_monitor_is_primary(const_cast<GdkMonitor*>(gobj()));
}
...
Glib::PropertyProxy_ReadOnly< Gdk::Rectangle > Monitor::property_workarea() const
{
  return Glib::PropertyProxy_ReadOnly< Gdk::Rectangle >(this, "workarea");
}
