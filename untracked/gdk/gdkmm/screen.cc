...
Screen& Screen::operator=(Screen&& src) noexcept
{
...
#ifndef GDKMM_DISABLE_DEPRECATED
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
int Screen::get_monitor_scale_factor(int monitor_num)
{
  return gdk_screen_get_monitor_scale_factor(gobj(), monitor_num);
}
G_GNUC_END_IGNORE_DEPRECATIONS
#endif // GDKMM_DISABLE_DEPRECATED
...
{
  return ::Cairo::FontOptions(const_cast<cairo_font_options_t*>(gdk_screen_get_font_options(const_cast<GdkScreen*>(gobj()))), false /* take_ownership */);
}
...
Glib::SignalProxy< void > Screen::signal_size_changed()
{
  return Glib::SignalProxy< void >(this, &Screen_signal_size_changed_info);
}


Glib::SignalProxy< void > Screen::signal_composited_changed()
{
  return Glib::SignalProxy< void >(this, &Screen_signal_composited_changed_info);
}


Glib::SignalProxy< void > Screen::signal_monitors_changed()
{
  return Glib::SignalProxy< void >(this, &Screen_signal_monitors_changed_info);
}
